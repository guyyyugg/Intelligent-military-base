function check_delete_email(x){
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: `${window.location.origin}/user2_showemail/:data_id/delete_email`,
                method: "POST",
                data: {id: x},
...
function check_add_device(x,x1,x2){
  ...
  $.ajax({
      url: `${window.location.origin}/user2_adddevice_add`,
      method: "POST",
      ...
      success: function(data) {
        if(data.success){
          console.log('login success')               
              ...
              setTimeout(function(){
              window.location.href = "/user2_showdevice";
              }
              ,2000)
        }else{
          Swal.fire({
...
function check_edit_device(x,x1,x2,x3){
  ...
  let place = x3;
  $.ajax({
      url: `${window.location.origin}/user2_edit_device/:data_id/edit_device`,
      method: "POST",
...
Swal.fire({
    ...
    if (result.isConfirmed) {
        $.ajax({
            url: `${window.location.origin}/user2_showdevice/:data_id/delete_device`,
            method: "POST",
            data: {id: x},
...
let status1 = x;
$.ajax({
    url: `${window.location.origin}/user2_device_status`,
    method: "POST",
...
function check_add_cctv(x,y,z){
  ...
  let longitude = $("#longitude").val();
  $.ajax({
      url: `${window.location.origin}/user2_addcamera_add`,
      method: "POST",
...
function check_edit_cctv(id,x,y,z){
  ...
  let longitude = $("#longitude").val();
  $.ajax({
      url: `${window.location.origin}/user2_edit_cctv`,
      method: "POST",
...
function check_delete_cctv(x){
  ...
  Swal.fire({
      ...
      if (result.isConfirmed) {
          $.ajax({
              url: `${window.location.origin}/user2_delete_cctv`,
              method: "POST",
              data: {id: x},
...
function cctv_update_status(x1,status){
  ...
  let status1 = x;
  $.ajax({
      url: `${window.location.origin}/user2_cctv_status`,
      method: "POST",
      data: {id:x1,status:status1},
