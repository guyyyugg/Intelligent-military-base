function check_delete_email(x){
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: `${window.location.origin}/user3_showemail/:data_id/delete_email`,
                method: "POST",
                data: {id: x},
                ...
                success: function(data) {
                        ...
                        setTimeout(function(){
                        window.location.href = "/user3_showemail";
                        }
                        ,2000)
...
function check_delete_log(x){
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: `${window.location.origin}/user3_showlog/:data_id/delete_log`,
                method: "POST",
                data: {id: x},
                ...
                success: function(data) {
                        ...
                        setTimeout(function(){
                        window.location.href = "/user3_showlog";
                        }
                        ,2000)
...
function check_edit_email(x){
  ...
  let place = $("#place").val();
  $.ajax({
      url: `${window.location.origin}/user3_edit_email/:data_id/edit_email`,
      method: "POST",
...
function check_edit_log(x){
  ...
  let log = $("#log").val();
  $.ajax({
      url: `${window.location.origin}/user3_edit_log/:data_id/edit_log`,
      method: "POST",
...
function check_add_place(){
  Swal.fire({
      ...
      url: `${window.location.origin}/user3_addplace_add`,
      method: "POST",
      ...
      success: function(data) {
              ...
              setTimeout(function(){
              window.location.href = "/user3_addplace";
              }
              ,2000)
  ...
  function check_delete_place(x){
      ...
      Swal.fire({
          ...
          if (result.isConfirmed) {
              $.ajax({
                  url: `${window.location.origin}/user3_addplace/:data_id/delete_place`,
                  method: "POST",
                  data: {id: x},
...
function check_edit_place(x,x1){
      ...
      Swal.fire({
          ...
          url: `${window.location.origin}/user3_edit_place/:data_id/edit_place`,
          method: "POST",
  ...
  function check_add_device(x,x1){
    ...
    $.ajax({
        url: `${window.location.origin}/user3_adddevice_add`,
        method: "POST",
        ...
        success: function(data) {
          if(data.success){
            console.log('login success')               
                ...
                setTimeout(function(){
                window.location.href = "/user3_showdevice";
                }
                ,2000)
          }else{
            Swal.fire({
...
function check_edit_device(x,x1,x2){
  ...
  let place = $("#place").val();;
  $.ajax({
      url: `${window.location.origin}/user3_edit_device/:data_id/edit_device`,
      method: "POST",
...
Swal.fire({
    ...
    if (result.isConfirmed) {
        $.ajax({
            url: `${window.location.origin}/user3_showdevice/:data_id/delete_device`,
            method: "POST",
            data: {id: x},
...
let status1 = x;
$.ajax({
    url: `${window.location.origin}/user3_device_status`,
    method: "POST",
...
let status1 = x;
$.ajax({
    url: `${window.location.origin}/user3_cctv_status`,
    method: "POST",
    data: {id:x1,status:status1},
...
function check_add_cctv(x,y){
  ...
  let longitude = $("#longitude").val();
  $.ajax({
      url: `${window.location.origin}/user3_addcamera_add`,
      method: "POST",
...
function check_edit_cctv(id,x,y){
  ...
  let longitude = $("#longitude").val();
  $.ajax({
      url: `${window.location.origin}/user3_edit_cctv`,
      method: "POST",
...
function check_delete_cctv(x){
  ...
  Swal.fire({
      ...
      if (result.isConfirmed) {
          $.ajax({
              url: `${window.location.origin}/user3_delete_cctv`,
              method: "POST",
              data: {id: x},
